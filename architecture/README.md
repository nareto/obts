...
- [`models/formal/README.md`](models/formal/README.md): bounded formal-model policy, the accepted `OBTS-FM-001` local apply/recovery model, and candidate `OBTS-FM-002` composed distributed model.
