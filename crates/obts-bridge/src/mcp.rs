...
const TOOLING_CATALOG_URI: &str = "obts-bridge://catalog/tooling.json";
const OPENAPI_SCHEMA_URI: &str = "obts-bridge://schemas/openapi.json";
const VAULT_FILE_RESOURCE_PREFIX: &str = "obts-bridge://files/";
        ...
        _ if uri.starts_with(VAULT_FILE_RESOURCE_PREFIX) => {
            ...
            if file_id.is_empty() {
                return Err(ErrorMetadata::new(
                    ...
                    false,
                    "file id is required",
                    "vault file resource URIs must include a non-empty canonical file id after obts-bridge://files/",
                ));
            }
...
impl IntoResponse for McpError {
    fn into_response(self) -> Response {
        ...
        let status = match self {
            ...
            McpError::Service(ServiceError::Forbidden) => StatusCode::FORBIDDEN,
            McpError::Service(ServiceError::HeadlessNotPaired | ServiceError::IndexCatchingUp) => {
