...
pub(crate) fn openapi_spec() -> Value {
    json!({
        ...
        "tags": [
            {
                "name": "obts_bridge",
                "description": "OBTS Bridge REST endpoints under /api/v1."
            }
        ],
        "components": {
            "securitySchemes": {
        ...
        "paths": {
            ...
            "/api/v1/admin/headless/command": {
                "post": {
                    ...
                    "responses": {
                        "200": {"description": "Headless command result"},
                        "400": json_response("#/components/schemas/ApiError", "Invalid or unsupported command"),
                        "401": json_response("#/components/schemas/ApiError", "Missing or invalid API key"),
                        "403": json_response("#/components/schemas/ApiError", "Admin context required"),
                        "503": json_response("#/components/schemas/ApiError", "Headless client unavailable")
                    }
                }
            },
            "/api/v1/notes": {
...
<html lang="en">
  <head>
    ...
    <title>OBTS Bridge API Docs</title>
    ...
    <script>
      window.onload = function() {
        if (!window.SwaggerUIBundle) {
          document.body.innerHTML = '<div class="fallback"><h1>OBTS Bridge API Docs</h1><p>Swagger UI assets failed to load. Raw OpenAPI document: <code>/api-doc/openapi.json</code></p></div>';
          return;
        }
